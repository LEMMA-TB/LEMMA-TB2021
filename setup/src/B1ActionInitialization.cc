...
void B1ActionInitialization::Build() const
{
	...
	SetUserAction(new B1SteppingAction(eventAction, runAction, fStoreCaloEnDepFlag, fStoreGammaConvDepFlag, fEThr, fDetEnterExitFlag, fTriggerLogic, fAug2018Flag));
