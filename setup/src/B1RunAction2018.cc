...
B1RunAction2018::B1RunAction2018(const std::map<G4int,G4int> & ChannelMap)
: G4UserRunAction(), fChannelMap(ChannelMap)
{}

B1RunAction2018::~B1RunAction2018(){}


G4Run* B1RunAction2018::GenerateRun(){
	return new B1Run;
}


void B1RunAction2018::BeginOfRunAction(const G4Run*){
...
void B1RunAction2018::EndOfRunAction(const G4Run* run){
