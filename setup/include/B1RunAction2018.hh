#ifndef B1RunAction2018_h
#define B1RunAction2018_h 1
...
class B1RunAction2018 : public G4UserRunAction
{
public:
	B1RunAction2018(const std::map<G4int,G4int> &);
	virtual ~B1RunAction2018();
