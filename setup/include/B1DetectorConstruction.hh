...
{
public:
	B1DetectorConstruction(G4bool TargetFlag, G4bool FlipFieldFlag, G4bool MagMapFlag, G4double GeometryZoom);
	...
	G4LogicalVolume* GetScoringVolume_Ce1tilt() const { return fScoringVolume_Ce1tilt; }
